...
/**
 * The class <code>AbstractBooterDaemonGeneratorTest</code> contains tests for the class <code>{@link AbstractBooterDaemonGenerator}</code>.
 *
 * @generatedBy CodePro at 11/11/19 3:34 AM
 * @author Filipe
 * @version $Revision: 1.0 $
 */
public class AbstractBooterDaemonGeneratorTest {
	/**
	...
	public void testGenerate_1()
		throws Exception {
		AbstractBooterDaemonGenerator fixture = AbstractBooterDaemonGeneratorFactory.createcreateUnixBooterDaemonGenerator();
		...
		//       at org.codehaus.mojo.appassembler.daemon.booter.AbstractBooterDaemonGenerator.generate(AbstractBooterDaemonGenerator.java:67)
	}
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(AbstractBooterDaemonGeneratorTest.class);
	}
}